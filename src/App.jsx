...
const TRANSLATIONS = {
  en: {
    ...
    dressCodeSubtitle: "We’d love if you dress up in an elegant yet comfortable way. The colors mentioned below are especially lovely for our celebration. Women may choose dresses or jumpsuits, and men may go with dress shirts and slacks. Most importantly, please wear whatever makes you feel happy, comfortable, and confident.",
  ...
  hy: {
    ...
    dressCodeSubtitle: "Ուրախ կլինենք, եթե հագնվեք էլեգանտ ու միևնույն ժամանակ հարմարավետ։ Ստորև նշված գույները հատկապես գեղեցիկ կլինեն մեր տոնական օրվա համար։ Կանայք կարող են ընտրել զգեստներ կամ կոմբինեզոններ, իսկ տղամարդիկ՝ վերնաշապիկներ և տաբատներ։ Ամենակարևորը՝ հագեք այն, ինչի մեջ կզգաք երջանիկ, հարմարավետ և ինքնավստահ։",
  ...
  ru: {
    ...
    dressCodeSubtitle: "Нам будет приятно, если вы выберете элегантный и в то же время комфортный образ. Указанные ниже цвета особенно красиво подойдут для нашего торжества. Женщины могут выбрать платья или комбинезоны, а мужчины — рубашки и брюки. Самое главное — надевайте то, в чём вы будете чувствовать себя счастливо, удобно и уверенно.",
